...
//    private final Logger logger = LoggerFactory.getLogger(BPMNTest.class);
//
//    @Test
...
//
//        BpmnModelInstance bpmnModel = new BpmnModelInstance();
...
//
//        // 部署流程
//        Deployment deploy = repositoryService.createDeployment().bpmn(PROCESSID + ".bpmn20.xml", bpmnModel).name(PROCESSNAME).deploy();
//
...
//        StartEvent startEvent = new StartEventBuilder().id("startEvent");
